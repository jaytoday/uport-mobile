...
class Accounts extends React.Component {
    ...
    openContact() {
        Linking.openURL('https://id.uport.me/req/eyJ0eXAiOiJKV1QiLCJhbGciOiJFUzI1NksifQ..z6ho5L-1xmYs6d4UwROYKenyIWJurlLK072gnq736T88QG53JM2dEaWNgXiSfPbBSVKFolHxYXPkd4ZqV2KD4A')
    }
            ...
            <TouchableOpacity
                ...
                <View style={styles.cardInner}>
                    ...
                    <View style={styles.banner}>
                        <Avatar size={150} style={{backgroundColor: '#50b2ca'}} source={accountProfile || {avatar: require('uPortMobile/images/eth-symbol2-white.png')}} />
                    </View>
                </View>
            </TouchableOpacity>
        )
